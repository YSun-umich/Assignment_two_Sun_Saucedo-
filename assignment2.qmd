...
\*When we filtered for the keyword "crime" in the interest over time data set, we found that the mean was 51.92 hits, the median was 52 hits, and the variance was 64.30. Additionally, within this data set we found that the mean hit for keyword "loan" was 63.62, the median was 61 hits, and the variance was 108.00.
